"""Executable proof tests for Slice II Structural Expansion I."""
...
PROOF = ROOT / "scripts" / "slice_ii_structural_expansion_i_proofs.py"
...
class SliceIIStructuralExpansionIProofTests(unittest.TestCase):
